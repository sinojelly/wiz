...
EXTERN_C const IID IID_IWizIECapture;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Save2( 
            /* [in] */ IDispatch *pHtmlDocument2Disp) = 0;
    ...
    typedef struct IWizIECaptureVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *Save2 )( 
            IWizIECapture * This,
            /* [in] */ IDispatch *pHtmlDocument2Disp);
...
#define IWizIECapture_Save2(This,pHtmlDocument2Disp)	\
    ( (This)->lpVtbl -> Save2(This,pHtmlDocument2Disp) ) 
